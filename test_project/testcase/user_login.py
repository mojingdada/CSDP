...
class CSDPTest(unittest.TestCase):
    ...
    def testCSDPLogin(self):
        ...
        # 输入用户名，密码（用例数据）
        self.userElement.send_keys("系统管理员")
        self.passwordElement.send_keys("123456")
    ...
    def testEntrySystemManage(self):
        u''' 跳转测试，进入系统管理'''
        self.systemManage = self.browser.find_element_by_xpath(
            '//*[@id="app"]/section/header/div/div[1]/div[1]/span/button').click()

    def testEntrySystemUserManage(self):
        u''' 跳转测试，进入系统用户管理'''
        self.systemUserManage = self.browser.find_element_by_xpath(
            '//*[@id="app"]/section/header/div/div[2]/div/ul[2]/li[3]/ul/li[2]/a').click()

    def testEntryNewUser(self):
        u''' 跳转测试，进入新建系统用户员'''
        self.newUser = self.browser.find_element_by_xpath('/html/body/app-component/div[1]/main-component/div/div/'
                                                          'manage-component/div/div/div/div[1]/div/div/div/div/div[3]/'
                                                          'button').click()
    ...
    def testNewUser(self):
        ...
        # self.yu.click()
        # self.deDomain.click()
        self.username.send_keys(newusername)
        self.turename.send_keys(truename)
        self.newpassword.send_keys(newpassword)
        self.denewpassword.send_keys(denewpassword)
        self.email.send_keys(email)
        self.phone.send_keys(phone)
        self.gudingphone.send_keys(gudingphone)
        self.QQ.send_keys(QQ)
...
# def testEntrySystemUserManage(self):
#     u''' 跳转测试，进入系统用户管理'''
#     self.systemUserManage = self.browser.find_element_by_xpath( "/html/body/app-component/div[1]/"
#                                                                 "main-component/header-component/header"
#                                                                 "/nav/div/div[1]/ul/li[1]/span/i" ).click()
